import React, {
  useState, useEffect, useCallback, memo, SyntheticEvent,
} from 'react';
...
const CustomNodeFlow = () => {
  ...
  useEffect(() => {
    const onChange = (event : SyntheticEvent) => {
      setElements((els : any[]) => els.map((e : any) => {
        if (isEdge(e) || e.id !== '2') {
          return e;
        }
  ...
  const onElementsRemove = useCallback(
    ...
    (elementsToRemove : any) => { setElements((els: any) => removeElements(elementsToRemove, els) as any); },
    [],
  );
