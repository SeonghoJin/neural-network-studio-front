...
import ReactFlow, {
  addEdge, ReactFlowProvider, useStoreState, Node, Edge, useStoreActions,
...
const onElementClick = (event : React.MouseEvent, element : Node | Edge) => console.log('click', element);
