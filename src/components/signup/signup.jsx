...
class Signup extends React.PureComponent {
  ...
  submit = () => {
    if (!this.state.pwApprove) {
      alert(
        '비밀번호는 반드시 기호, 영문, 숫자를 포함한 8자리이상으로 해야합니다.'
      );
      return;
            ...
            <main>
              <div className={`${style.signupForm} `}>
                ...
                <div className={`${utils.inputWrapper} ${utils.flexColumn}`}>
                  ...
                  {this.state.pwValue === '' ? (
                    <span className={`${style.requirement}`}>
                      기호, 영문, 숫자를 포함한 8자리 이상
                    </span>
                ...
                <div className={`${utils.inputWrapper} ${utils.flexColumn}`}>
                  ...
                  {this.state.pwValid === '' ? (
                    ...
                    <span className={`${style.requirement} ${style.green}`}>
                      맞습니다.
                    </span>
                  ) : (
                    <span className={`${style.requirement} ${style.red}`}>
                ...
                <div className={style.pwVisible}>
                  ...
                  <a
                    ...
                    className={`${utils.iconButton}`}
                  >
                    <FontAwesomeIcon
                      icon={this.state.pwVisible ? faEyeSlash : faEye}
                    />
                  </a>
                </div>
